    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.games.update", [$game->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('app') ? 'is-invalid' : '' }}" type="text" name="app" id="app" value="{{ old('app', $game->app) }}" required>
                @if($errors->has('app'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('secret') ? 'is-invalid' : '' }}" type="text" name="secret" id="secret" value="{{ old('secret', $game->secret) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', $game->status) }}">
