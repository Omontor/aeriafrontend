                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.analytics.update", [$analytic->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('bvc') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="bvc" id="bvc" value="{{ old('bvc', $analytic->bvc) }}">
                            @if($errors->has('bvc'))
                        ...
                        <div class="form-group {{ $errors->has('entry') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="entry" id="entry" value="{{ old('entry', $analytic->entry) }}">
                            @if($errors->has('entry'))
