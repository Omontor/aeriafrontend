                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.messages.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('publish_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="publish_date" id="publish_date" value="{{ old('publish_date', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('expiration_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="expiration_date" id="expiration_date" value="{{ old('expiration_date', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('data_type') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="data_type" id="data_type" value="{{ old('data_type', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('custom_data') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="custom_data" id="custom_data" value="{{ old('custom_data', '') }}">
