    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.messages.update", [$message->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('publish_date') ? 'is-invalid' : '' }}" type="text" name="publish_date" id="publish_date" value="{{ old('publish_date', $message->publish_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('expiration_date') ? 'is-invalid' : '' }}" type="text" name="expiration_date" id="expiration_date" value="{{ old('expiration_date', $message->expiration_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subject') ? 'is-invalid' : '' }}" type="text" name="subject" id="subject" value="{{ old('subject', $message->subject) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('message') ? 'is-invalid' : '' }}" type="text" name="message" id="message" value="{{ old('message', $message->message) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('uri') ? 'is-invalid' : '' }}" type="text" name="uri" id="uri" value="{{ old('uri', $message->uri) }}">
                @if($errors->has('uri'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('data_type') ? 'is-invalid' : '' }}" type="text" name="data_type" id="data_type" value="{{ old('data_type', $message->data_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', $message->country) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('custom_data') ? 'is-invalid' : '' }}" type="text" name="custom_data" id="custom_data" value="{{ old('custom_data', $message->custom_data) }}">
