        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('custom_key_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.custom-keys.index") }}" class="nav-link {{ request()->is("admin/custom-keys") || request()->is("admin/custom-keys/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fab fa-keycdn">

                            </i>
                            <p>
                                {{ trans('cruds.customKey.title') }}
                            </p>
                        </a>
                    </li>
                @endcan
